    ...
    <div className="relative w-full min-h-screen">
      ...
      <div className="absolute top-6 right-6 z-20">
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent
            side="right"
            className="bg-gradient-to-b from-indigo-950 to-blue-900 border-purple-500/30 text-white w-80 transition-all animate-slide-in-right duration-300 
          ...
          >
            <SheetHeader className='pr-[140px]'>
              <SheetTitle className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent cursor-pointer" onClick={handleNewChat}>
